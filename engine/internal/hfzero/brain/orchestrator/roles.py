...
except ImportError:  # py3.10 (the HF ZeroGPU image) — drop-in shim
    from enum import Enum

    class StrEnum(str, Enum):
        """py3.10 backport: StrEnum landed in 3.11 (PEP 666-lite)."""
        def __str__(self) -> str:  # match 3.11's str() behavior
            return self.value
