...
#   fanout:       dict|None     — {"over": "outline.topics", "max_parallel": 8}
...
DEFAULT_TEMPLATES: list[dict] = [
    # 1. research_paper — 10-stage research pipeline (from reference repo)
    {
        ...
        "stages": [
            ...
            {"name": "source_discovery", "role": "planner", "instructions": "For this topic, identify 1-10 specific URLs pointing to peer-reviewed articles, academic papers, or authoritative sources. Output JSON array: [{\"url\": str, \"title\": str, \"relevance\": str}]. DO NOT invent URLs. Prefer .edu, .gov, arxiv.org, nature.com, science.org. If uncertain, OMIT it.", "fanout": {"over": "outline.topics", "max_parallel": 8}, "inputs": ["outline.topics.{i}"], "max_tokens": 1200},
    ...
    # 4. code_review — multi-stage code review pipeline
    {
        ...
        "stages": [
            ...
            {"name": "review_file", "role": "critiquer", "instructions": "Review this file for: bugs, security issues (injection, auth, crypto misuse), performance, readability. Output JSON: [{\"severity\": \"high|medium|low\", \"line\": int|null, \"issue\": str, \"fix\": str}]. Be specific — cite line numbers.", "fanout": {"over": "parse_structure.files", "max_parallel": 8}, "inputs": ["parse_structure.files.{i}", "prompt"], "max_tokens": 1500},
    ...
    # 11. redteam — red team attack pipeline
    {
        ...
        "stages": [
            ...
            {"name": "generate_attacks", "role": "generator", "instructions": "For this attack surface, generate 3-5 plausible attacks (NOT exploit code — describe the attack vector). Output JSON: [{\"attack\": str, \"vector\": str, \"preconditions\": str, \"impact\": str}]. Be specific to the surface.", "fanout": {"over": "attack_surface.surfaces", "max_parallel": 8}, "inputs": ["attack_surface.surfaces.{i}", "prompt"], "max_tokens": 1200},
