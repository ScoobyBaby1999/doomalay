...
// handleKeysValidate is GET /api/keys/validate?env_var=OPENROUTER_API_KEY —
// pings the provider's /v1/models endpoint to verify the key works.
// Returns {valid: true, model_count: N} or {valid: false, error: "..."}.
